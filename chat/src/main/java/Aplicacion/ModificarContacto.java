...
import java.awt.FlowLayout;
	...
	public class ModificarContacto {
		...
		private void initialize() {
		    ...
		    JLabel titulo = new JLabel("Modificar Contacto");
		    ...
		    txtTelefono = new JTextField(c.getTelefono());
		    ...
		    btnAceptar.addActionListener(new ActionListener() {
		        public void actionPerformed(ActionEvent e) {
		            if(!txtNombre.getText().trim().isEmpty()) {//Si contiene algo 
		            	Controlador.INSTANCE.modificarContacto(c, txtNombre.getText());
